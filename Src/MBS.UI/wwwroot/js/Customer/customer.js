...
function loadDataTable() {
    ...
    dataTable = $('#CustomerTbl').DataTable({
        ...
        ajax: '/ShopUser/Customers/GetAll',
        columns: [
...

            {
                ...
                "render": function (data, type, full, meta) {
                    return '<div class="dropdown action-button mx-2">'
                        ...
                        + '<li><a class="dropdown-item text-primary" href="/ShopUser/Customers/Upsert?Id=' + data + '"><i class="fa-solid fa-pen-to-square"></i> Edit</a></li>'
...
function Delete(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "/ShopUser/Customers/Delete/" + id,
                type: 'DELETE',
